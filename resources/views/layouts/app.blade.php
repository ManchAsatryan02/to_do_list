...
<head>
    ...
    @vite(['resources/sass/app.scss', 'resources/js/app.js', 'resources/css/app.css', 'resources/js/process.js', 'resources/js/bootstrap.js'])
                        ...
                        @else
                            <li class="nav-item dropdown">
                                ...
                                <div class="dropdown-menu dropdown-menu-end" aria-labelledby="navbarDropdownAuth">
                                    <div aria-labelledby="navbarDropdownAuth">
